...
<body>
	<div class="container">
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" 
		      ...
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        <li class="nav-item">
		          <a class="nav-link" aria-current="page" href="index.php">Veikals</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link active" href="add-book.php">Pievienot Grāmatu</a>
		        </li>
		        <li class="nav-item">
        ...
        <form action="php/add-book.php" method="post" enctype="multipart/form-data" class="shadow p-4 rounded mt-5 w-90">
            ...
            <button type="submit" class="btn btn-primary">Pievienot Grāmatu</button>
        </form>
	</div>
</body>
</html>
